# AI Stock Sentinel: Roadmap

- [x] Educación Proactiva: Crear Guía Estratégica de Trading de IA <!-- id: 1 -->
- [x] Investigación Profunda: Análisis de Mercado de "Monopolios de IA" <!-- id: 1.5 -->
- [x] Configuración: Obtener API Keys de Alpaca (Paper Trading) <!-- id: 2 -->
- [x] Implementación: Prototipo de Stock Watcher (Scraper de Precios de IA) <!-- id: 3 -->
